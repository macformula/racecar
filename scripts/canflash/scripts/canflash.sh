...
# connect GPIO pin from RPi GPIO 21 to STM CN11 Pin 7
...
cd sys/class/gpio/
echo 21 > export
echo out > gpio21/direction #gain control of GPIO pin
echo 1 > gpio21/value # GPIO signal high
sleep 1
...
sleep 1
echo 0 > gpio21/value #GPIO signal low
echo 21 > unexport #release control of GPIO pin
