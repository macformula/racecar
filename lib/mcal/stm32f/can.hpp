...
public:
    ...
    void Setup();
    void Send(const macfe::can::RawMessage& can_tx_msg) override;
    void Receive();
...
private:
    ...
    void SendLL(const macfe::can::RawMessage& can_tx_msg);
    ...
    uint8_t tx_queue_storage[sizeof(macfe::can::RawMessage) * TX_QUEUE_SIZE];
