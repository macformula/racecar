...
// macfe::periph::AnalogInput& wheel_speed_rear_left =
// mcal::wheel_speed_rear_left; macfe::periph::AnalogInput&
// wheel_speed_rear_right =
//     mcal::wheel_speed_rear_right;

// // =========== Driver Control ==============================
// macfe::periph::AnalogInput& steering_angle_sensor =
// mcal::steering_angle_sensor; macfe::periph::AnalogInput& accel_pedal_sensor1
// = mcal::accel_pedal_sensor1; macfe::periph::AnalogInput& accel_pedal_sensor2
// = mcal::accel_pedal_sensor2; macfe::periph::AnalogInput&
// brake_pressure_sensor = mcal::brake_pressure_sensor;
