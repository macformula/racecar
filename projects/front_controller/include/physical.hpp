...
// Needs to be tuned
constexpr float bpps_volt_pos_0 = 0.318;
constexpr float bpps_volt_pos_100 = 1.023;  // 250 PSI
...
// Needs to be tuned
constexpr float steer_volt_straight = 1.86;
constexpr float steer_volt_full_right = 2.74;
