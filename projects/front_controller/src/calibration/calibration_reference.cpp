...
//                 calib_data.apps1_min = measurement_accumulator /
//                 sample_count; calib_data.apps2_min = apps2;  // Could also
...
//                 sample_count++;
//             } else {
//                 calib_data.apps1_max = measurement_accumulator /
//                 sample_count; calib_data.apps2_max = apps2; new_state =
//                 CALIBRATE_BPPS_MIN; measurement_accumulator = 0.0f;
//                 sample_count = 0;
//             }
//         } break;
