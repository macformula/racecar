 ...
 * command packets as power up initialization sequence of the KoD LCD (OTM8009A
 * LCD Driver)
 */
 ...
 * YS[15:0] = 0x000 = 0, YE[15:0] = 0x31F = 799 for portrait mode : : apply to
 * PASET
 */
 ...
 * CASET YS[15:0] = 0x000 = 0, YE[15:0] = 0x1DF = 479 for landscape mode : apply
 * to PASET
 */
...
/**
 * @brief  Initializes the LCD KoD display part by communication in DSI mode in
 * Video Mode with IC Display Driver OTM8009A (see IC Driver specification for
 * more information).
