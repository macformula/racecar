...
/**
 * @brief  Initializes the LCD Frida display part by communication in DSI mode
 * in Video Mode with IC Display Driver NT35510 (see IC Driver specification for
 * more information).
...
uint8_t NT35510_Init(uint32_t ColorCoding, uint32_t orientation) {
    ...
    const uint8_t nt35510_caset_portrait[] = {0x00, 0x00, 0x01, 0xDF,
                                              NT35510_CMD_CASET};
    const uint8_t nt35510_raset_portrait[] = {0x00, 0x00, 0x03, 0x1F,
                                              NT35510_CMD_RASET};
    const uint8_t nt35510_madctl_landscape[] = {NT35510_CMD_MADCTL, 0x60};
    const uint8_t nt35510_caset_landscape[] = {0x00, 0x00, 0x03, 0x1F,
                                               NT35510_CMD_CASET};
    const uint8_t nt35510_raset_landscape[] = {0x00, 0x00, 0x01, 0xDF,
                                               NT35510_CMD_RASET};
    ...
    /* Note : defaut is 0 (lowest Brightness), 0xFF is highest Brightness, try
     * 0x7F : intermediate value */
    ...
    /* defaut is 0, try 0x02 - image Content based Adaptive Brightness [Still
     * Picture] */
