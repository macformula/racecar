...
/** @defgroup STM32469I_Discovery_LOW_LEVEL_Exported_Types STM32469I Discovery
...
/** @defgroup STM32469I_Discovery_LOW_LEVEL_Exported_Constants STM32469I
 * Discovery LOW LEVEL Exported Constants
 * @{
 */

/** @defgroup STM32469I_Discovery_LOW_LEVEL_LED STM32469I Discovery LOW LEVEL
 * LED
 * @{
 */
...
/** @addtogroup STM32469I_Discovery_LOW_LEVEL_BUTTON STM32469I Discovery LOW
 * LEVEL BUTTON
 * @{
 */
...
/**
 * @brief User can use this section to tailor I2C1/I2C1 instance used and
 * associated resources. Definition for I2C1 clock resources
 */
...
/**
 * @brief User can use this section to tailor I2C2/I2C2 instance used and
 * associated resources (audio codec). Definition for I2C2 clock resources
 */
...
#define DISCO_I2C2_ER_IRQn I2C2_ER_IRQn
    ...
    !defined(USE_STM32469I_DISCO_REVB) && !defined(USE_STM32469I_DISCO_REVC)
...
/** @defgroup STM32469I_Discovery_LOW_LEVEL_Exported_Macros STM32469I Discovery
 * LOW LEVEL Exported Macros
 * @{
 */
/**
 * @}
...
/** @defgroup STM32469I_Discovery_LOW_LEVEL_Exported_Functions STM32469I
