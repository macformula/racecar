...
void StatusBar::Create(lv_obj_t* parent) {
    ...
    lv_obj_set_style_bg_color(bar_container_, lv_color_hex(0xFF4500), LV_PART_MAIN);  // Orange-red
    ...
    lv_obj_set_flex_align(icon_container_, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
...
int StatusBar::AddWarning(const char* icon_text) {
    ...
    lv_obj_set_style_text_color(icon_label, lv_color_hex(0xFFFFFF), LV_PART_MAIN);  // White text
