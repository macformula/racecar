...
int main(void) {
    ...
    //initialize input buttons to simulate keypad (keyboard) tab and enter buttons
    ...
    indev_drv_btn.read_cb = [](lv_indev_drv_t* indev_drv, lv_indev_data_t* data) {
    ...
    while (1) {
        ...
        //Testing code ---------------------------------------------------------------
        //simulates waiting for CAN confirmation that the vehicle is ready to start HV
        //after confirm button press, wait 2 seconds before allowing HV startup
        ...
        //simulates waiting for CAN confirmation that motors are enabled and ready
        //after motors enabled, wait 2 seconds before showing ready-to-drive screen
        ...
        //shows ready-to-drive message for 3 seconds before switching to drive mode
