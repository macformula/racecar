...
void StartMotors::create_menu() {
    ...
    lv_obj_t* start_motors_menu = lv_obj_create(NULL); // Create a new screen
    Menu::init_menu(start_motors_menu);
    ...
    lv_obj_add_event_cb(start_hv_btn, start_motors_btn_handler, LV_EVENT_CLICKED, NULL);
    ...
    lv_obj_t* led2 = lv_obj_create(start_motors_menu);
    ...
    lv_obj_t* led3 = lv_obj_create(start_motors_menu);
