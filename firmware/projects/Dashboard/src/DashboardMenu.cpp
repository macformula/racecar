...
void DashboardMenu::create_menu() {
    ...
    lv_obj_add_event_cb(drive_mode_btn, drive_btn_event_handler, LV_EVENT_CLICKED, NULL);
    ...
    lv_obj_add_event_cb(profiles_btn, profiles_btn_event_handler, LV_EVENT_CLICKED, NULL);
    ...
    lv_obj_add_event_cb(debug_btn, debug_btn_event_handler, LV_EVENT_CLICKED, NULL);
