...
ADCInput temp_sensor_adc_1("Temp Sensor 1");
ADCInput temp_sensor_adc_2("Temp Sensor 2");
ADCInput temp_sensor_adc_3("Temp Sensor 3");
ADCInput temp_sensor_adc_4("Temp Sensor 4");
ADCInput temp_sensor_adc_5("Temp Sensor 5");
ADCInput temp_sensor_adc_6("Temp Sensor 6");
