...
void test_1(const shared::util::Mapper<float>& pedal_to_torque,
    ...
    VdOutput output_1_expected{.lm_torque_limit_positive = 0.0f,
    ...
    std::cout << "Output 1: (negative torque limits and speed requests are "
                 "always constant)"
              << std::endl;
    std::cout << "lm_torque_limit_positive: "
              << output_1.lm_torque_limit_positive << std::endl;
    std::cout << "rm_torque_limit_positive: "
              << output_1.rm_torque_limit_positive << std::endl;

    ASSERT_CLOSE(output_1.lm_torque_limit_positive,
...
void test_2(const shared::util::Mapper<float>& pedal_to_torque,
    ...
    VdOutput output_2_expected{
        // Expected to calculate torque limit of 100.0f for both motors given
        // test 2 input
        // Expected output of 50.0f after accounting for running avg of motor
        // torque and test 1
        .lm_torque_limit_positive = 50.0f, .rm_torque_limit_positive = 50.0f,
        .lm_torque_limit_negative = 0.0f,  .rm_torque_limit_negative = 0.0f,
        .left_motor_speed_request = 1000,  .right_motor_speed_request = 1000};

    std::cout << "Output 2: (negative torque limits and speed requests are "
                 "always constant)"
              << std::endl;
    std::cout << "lm_torque_limit_positive: "
              << output_2.lm_torque_limit_positive << std::endl;
    std::cout << "rm_torque_limit_positive: "
              << output_2.rm_torque_limit_positive << std::endl;

    ASSERT_CLOSE(output_2.lm_torque_limit_positive,
...
void test_3(const shared::util::Mapper<float>& pedal_to_torque,
    ...
    VdOutput output_3_expected{
        // Expected to calculate lm=100.0f, rm=68.3f torque limits given test 3
        // input
        // Expected output of lm=66.7, rm=66.7*.683=45.5f after accounting for
        // running avg of motor torque and prev tests
        .lm_torque_limit_positive = 66.66667f,
        .rm_torque_limit_positive = 45.53336f,  // 5 decimal places due to
                                                // tolerance
        .lm_torque_limit_negative = 0.0f,
        .rm_torque_limit_negative = 0.0f,
        .left_motor_speed_request = 1000,
    ...
    std::cout << "Output 3: (negative torque limits and speed requests are "
                 "always constant)"
              << std::endl;
    std::cout << "lm_torque_limit_positive: "
              << output_3.lm_torque_limit_positive << std::endl;
    std::cout << "rm_torque_limit_positive: "
              << output_3.rm_torque_limit_positive << std::endl;

    ASSERT_CLOSE(output_3.lm_torque_limit_positive,
...
void test_4(const shared::util::Mapper<float>& pedal_to_torque,
    ...
    VdOutput output_4_expected{
        ...
        // Moving avg: (prev torque limits) / count = (0 + 100 + 100 + 50) / 4
        // = 62.5f
    ...
    std::cout << "Output 4: (negative torque limits and speed requests are "
              ...
              << std::endl;
    std::cout << "lm_torque_limit_positive: "
              << output_4.lm_torque_limit_positive << std::endl;
    std::cout << "rm_torque_limit_positive: "
              << output_4.rm_torque_limit_positive << std::endl;

    ASSERT_CLOSE(output_4.lm_torque_limit_positive,
                 output_4_expected.lm_torque_limit_positive);
    ASSERT_CLOSE(output_4.rm_torque_limit_positive,
...
void test_5(const shared::util::Mapper<float>& pedal_to_torque,
    ...
    VdOutput output_5_expected{
        ...
        // Moving avg: (prev torque limits) / count = (0 + 100 + 100 + 50 + 0) /
        // 5 = 50.0f
    ...
    std::cout << "Output 5: (negative torque limits and speed requests are "
              ...
              << std::endl;
    std::cout << "lm_torque_limit_positive: "
              << output_5.lm_torque_limit_positive << std::endl;
    std::cout << "rm_torque_limit_positive: "
              << output_5.rm_torque_limit_positive << std::endl;

    ASSERT_CLOSE(output_5.lm_torque_limit_positive,
                 output_5_expected.lm_torque_limit_positive);
    ASSERT_CLOSE(output_5.rm_torque_limit_positive,
...
void test_6(const shared::util::Mapper<float>& pedal_to_torque,
    ...
    VdOutput output_6_expected{.lm_torque_limit_positive = 0.0f,
                               .rm_torque_limit_positive = 0.0f,
                               .lm_torque_limit_negative = 0.0f,
                               .rm_torque_limit_negative = 0.0f,
                               .left_motor_speed_request = 1000,
    ...
    std::cout << "Output 6: (negative torque limits and speed requests are "
                 "always constant)"
              << std::endl;
    std::cout << "lm_torque_limit_positive: "
              << output_6.lm_torque_limit_positive << std::endl;
    std::cout << "rm_torque_limit_positive: "
              << output_6.rm_torque_limit_positive << std::endl;

    ASSERT_CLOSE(output_6.lm_torque_limit_positive,
...
void test_7(const shared::util::Mapper<float>& pedal_to_torque,
    ...
    std::cout << "Output 7: (negative torque limits and speed requests are "
                 "always constant)"
              << std::endl;
    std::cout << "lm_torque_limit_positive: "
              << output_7.lm_torque_limit_positive << std::endl;
    std::cout << "rm_torque_limit_positive: "
              << output_7.rm_torque_limit_positive << std::endl;

    ASSERT_CLOSE(output_7.lm_torque_limit_positive,
