...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        Case{
            TxStatusAligned{false, false},
            RawMessage{259, false, 4, (uint8_t[]){0, 0, 0, 0}},
        },
        Case{
            TxStatusAligned{false, true},
            RawMessage{259, false, 4, (uint8_t[]){0, 0, 0, 1}},
        },
        Case{
            TxStatusAligned{true, false},
            RawMessage{259, false, 4, (uint8_t[]){0, 0, 1, 0}},
        },
        Case{
            TxStatusAligned{true, true},
            RawMessage{259, false, 4, (uint8_t[]){0, 0, 1, 1}},
        }));

INSTANTIATE_TEST_SUITE_P(
    TxStatusNonAligned, TxTest,
    ::testing::Values(
        Case{
            TxStatusNonAligned{false, false},
            RawMessage{258, false, 2, (uint8_t[]){0x00, 0x00}},
        },
        Case{
            TxStatusNonAligned{true, false},
            RawMessage{258, false, 2, (uint8_t[]){0x00, 0x08}},
        },
        Case{
            TxStatusNonAligned{false, true},
            RawMessage{258, false, 2, (uint8_t[]){0x00, 0x10}},
        },
        Case{TxStatusNonAligned{true, true},
             RawMessage{258, false, 2, (uint8_t[]){0x00, 0x18}}}));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        Case{
            ...
            RawMessage{263, false, 2, (uint8_t[]){0x00, 0x00}},
        },
        Case{
            TxEnum{TxEnum::ecu_t::FrontController, TxEnum::state_t::Valid},
            RawMessage{263, false, 2, (uint8_t[]){0x00, 0x01}},
        },
        Case{
            TxEnum{TxEnum::ecu_t::TMS, TxEnum::state_t::Invalid},
            RawMessage{263, false, 2, (uint8_t[]){0x02, 0x02}},
        },
        Case{
            TxEnum{TxEnum::ecu_t::TMS, TxEnum::state_t::Waiting},
            RawMessage{263, false, 2, (uint8_t[]){0x02, 0x00}},
        },
        Case{
            TxEnum{TxEnum::ecu_t::LVController, TxEnum::state_t::Valid},
            RawMessage{263, false, 2, (uint8_t[]){0x01, 0x01}},
        },
        Case{TxEnum{TxEnum::ecu_t::LVController, TxEnum::state_t::Invalid},
             RawMessage{263, false, 2, (uint8_t[]){0x01, 0x02}}}));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        Case{
            ...
            RawMessage{262, false, 6,
                       (uint8_t[]){0xf3, 0x25 | 0x80, 0x16 | 0x50, 0xa3, 0x94,
                                   0x0e | 0x10 | 0xA0}},
        },
        Case{
