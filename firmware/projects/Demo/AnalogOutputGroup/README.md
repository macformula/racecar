# Firmware Demo Project: Analog Output Group 🎛️
...
**Analog Outputs:** 📊
- `analog_output0`, `analog_output1`, `analog_output2`, `analog_output3`: The four analog outputs that can be controlled.

**Analog Output Group:** 📊📊📊📊
- `analog_output_group`: A group containing the four analog outputs, which can be simultaneously updated.
...
+----------------+ +------------------+------------------+ 
         ...
         v                 v              
+-------------------------------+  +---------------------+
|        Control Logic          |  | analog_output_group |
