...
template <typename T>
T CreateTorqueVectoringFactor(T steering_angle, bool enable_torque_vectoring) {
    if (enable_torque_vectoring == false) {
        return 0;
    } else {
        ...
        static shared::util::LookupTable<table_length> tv_lookup_table{
            table_data};
